class BuildConfigs {
  static const String _stgUrlPrefix = "https://stg/zahran";
  static const String _betaUrlPrefix = "https://production/zahran";

  static const String BASE_URL_PREFIX = BuildConfigs._betaUrlPrefix;
  static bool isLiveBuild() => BASE_URL_PREFIX == _betaUrlPrefix && BASE_URL_PREFIX != _stgUrlPrefix;
}

class GeneralConfigs {
  static const String BASE_URL = BuildConfigs.BASE_URL_PREFIX + "/api";
  static const String OPS_DASHBOARD_BASE_URL = BuildConfigs.BASE_URL_PREFIX + "/ops/";
