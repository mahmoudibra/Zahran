...
abstract class BaseGenericRepositry<T> {
  Uri get baseUrl;

  Map<String, dynamic> resolveResponse(dio.Response<String> response) {
    try {
  ...
  T mapItem(Map<String, dynamic> json);
  ...
  Future<ApiDataResponse<T>> get({
    required String path,
    Map<String, dynamic>? queryParams,
    MapingCallBack<T>? mapItem,
  ...
  Future<ApiListResponse<T>> paging({
    required String path,
    Map<String, dynamic>? queryParams,
    ResolveResponseCallback? resolveResponse,
    MapingCallBack<T>? mapItem,
  ...
  Future<ApiDataResponse<T>> patch({
    required String path,
    Map<String, dynamic>? queryParams,
    MapingCallBack<T>? mapItem,
    Map<String, dynamic> data = const <String, dynamic>{},
  ...
  Future<ApiDataResponse<T>> delete({
    required String path,
    Map<String, dynamic>? queryParams,
    ResolveResponseCallback? resolveResponse,
    MapingCallBack<T>? mapItem,
